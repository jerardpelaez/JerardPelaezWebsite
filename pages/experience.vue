      ...
      <ol class="timeline-list">
        <li class="timeline-item">
          ...
          <div class="flex-container">
            ...
            <div>
              <span class="chip primary"> Vue </span>
            </div>
             <div>
              <span class="chip primary"> FairyGUI </span>
            </div>
            <div>
              <span class="chip primary"> LayaBox </span>
            </div>
            <div>
              <span class="chip primary"> Jira </span>
            </div>
            <div>
              <span class="chip primary"> GitLab </span>
            </div>
          </div>
        </li>
        ...
        <li class="timeline-item">
          ...
          <div class="flex-container">
            ...
            <div>
              <span class="chip primary"> Quasar </span>
            </div>
            <div>
              <span class="chip primary"> Cordova </span>
            </div>
            <div>
              <span class="chip primary"> Asana </span>
            </div>
            <div>
              <span class="chip primary"> Adobe XD </span>
            </div>
            <div>
              <span class="chip primary"> Github </span>
            </div>
            <div>
              <span class="chip primary"> Slack </span>
            </div>
          </div>
        </li>

        <li class="timeline-item">
          <h4 class="h4 timeline-item-title">Bizmates Philippines Inc.</h4>
          ...
          <div class="flex-container">
            ...
            <div>
              <span class="chip primary"> Vuetify </span>
            </div>
            <div>
              <span class="chip primary"> Nuxt </span>
            </div>
            <div>
              <span class="chip primary"> Laravel </span>
            </div>
            <div>
              <span class="chip primary"> Jira </span>
            </div>
        ...
        <li class="timeline-item">
          <h4 class="h4 timeline-item-title">AllValue Holdings Corp.</h4>
          ...
          <div class="flex-container">
            <div>
              <span class="chip primary"> Desktop Troubleshooting </span>
            </div>
            <div>
              <span class="chip primary"> Active Directory </span>
            </div>
            <div>
              <span class="chip primary"> DNS Settings </span>
            </div>
            <div>
              <span class="chip primary"> Antivirus Software </span>
            </div>
            <div>
              <span class="chip primary"> Network Troubleshooting </span>
            </div>
            <div>
              <span class="chip primary"> Hardware Setup </span>
            </div>
          </div>
        </li>
      </ol>
